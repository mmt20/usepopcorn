    ...
    <div>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MovieList onSelectMovie={handelSelectMovie} movies={movies} />
          )}
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  // if (imdbRating > 8) return <p>Mostafa Taha</p>;
  ...
  function handelAdd() {
    const newWatchedMovie = {
      ...
      userRating,
      countRatingDecisiongs: countRef.current,
    };
